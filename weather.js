...
const currenyDateTxt = document.querySelector(".current-date-txt");

const forecastsItemsContainer = document.querySelector(
...
const apiKeys = "bae87ee91e66e18164c83769f53c2e62";
...
async function updateWeatherInfo(city) {
  ...
  currenyDateTxt.textContent = getCurrentDate();
...
function updateForecatsItems(forecastWeather) {
  const {
    dt_txt: date,
    weather: [{ id }],
    main: { temp },
  ...
  const forecastItem = `
        <div class="forecast-item">
            ...
            <img src="weather/${getWeatherIcon(
              id
